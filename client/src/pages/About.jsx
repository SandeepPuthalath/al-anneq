  ...
  return (
    <div className="overflow-hidden">
      ...
      <motion.div
        ...
        className="px-4 md:px-8 mt-16 mb-8"
      >
      ...
      >
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="w-full lg:w-1/2 space-y-12 md:space-y-16">
            ...
            <motion.div variants={smoothFadeUp} transition={{ delay: 0.15 }}>
      ...
      <motion.div
        ...
        viewport={{ once: true, margin: "-100px" }}
        variants={smoothFadeUp}
        className="bg-[#211D1EF5] text-white py-16 px-4"
      >
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <motion.div
            ...
            {[
              {
                ...
                desc: "Dedicated supervisors ensuring quality and timely delivery.",
              },
              {
                title: "Skilled Labour",
                desc: "Trained professionals delivering superior workmanship.",
              },
              {
                title: "Qualified Engineers",
                desc: "Expert project engineers with extensive technical knowledge.",
              },
            ].map((member, index) => (
              <motion.div
                key={member.title}
              ...
              >
                <div className="flex justify-center mb-4">
                  {/* Keep your original SVGs here – one for each role */}
                  {index === 0 && (
                    <svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                      {/* Your first SVG path content */}
      ...
      <motion.div
        ...
        viewport={{ once: true, margin: "-100px" }}
        variants={smoothFadeUp}
        className="bg-[#272D2D] text-[#F8F8F8] py-12 px-4"
      >
        <div className="max-w-8xl mx-auto">
          {/* Why Choose Us */}
          <div className="mb-8">
            <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16 mb-6">
              <motion.div
              ...
              <div className="space-y-8 md:space-y-12">
                ...
                <div className="flex flex-wrap gap-6 md:gap-28">
                  {["Quality Workmanship", "Competitive Pricing", "Timely Project Delivery"].map((point, i) => (
                    <motion.div
                      key={point}
          ...
          >
            ...
            <p className="text-[#F8F8F8] text-md mb-1">alaneeqgm@gmail.com</p>
