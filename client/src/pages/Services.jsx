  ...
  const Services = () => {
    ...
    return (
      <div className="pt-16">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="mb-4">
            {/* Wall Coverings */}
            <Link to="/services/wall-coverings" className="group px-2 py-4 border-b border-[#7FC5C5] flex justify-between items-center hover:bg-[#BDE1E1] transition-all duration-300">
              <h3 className="text-[#211D1E] font-medium transition-colors">Wall Coverings</h3>
              <svg className="opacity-0 group-hover:opacity-100 transition-opacity duration-300" width="20" height="20" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M27.6353 10.9791C28.3429 10.9791 28.9166 11.5527 28.9166 12.2603V27.6354C28.9166 28.343 28.3429 28.9166 27.6353 28.9166H12.2603C11.5526 28.9166 10.979 28.343 10.979 27.6354C10.979 26.9276 11.5526 26.3541 12.2603 26.3541H26.3541V12.2603C26.3541 11.5527 26.9276 10.9791 27.6353 10.9791Z" fill="#211D1E"/>
            ...
            {/* Flooring Solutions */}
            <Link to="/services/flooring-solutions" className="group px-2 py-4 border-b border-[#7FC5C5] flex justify-between items-center hover:bg-[#BDE1E1] transition-all duration-300">
    ...
    <path d="M27.6353 10.9791C28.3429 10.9791 28.9166 11.5527 28.9166 12.2603V27.6354C28.9166 28.343 28.3429 28.9166 27.6353 28.9166H12.2603C11.5526 28.9166 10.979 28.343 10.979 27.6354C10.979 26.9276 11.5526 26.3541 12.2603 26.3541H26.3541V12.2603C26.3541 11.5527 26.9276 10.9791 27.6353 10.9791Z" fill="#211D1E"/>
            ...
            {/* Wall Paintings */}
            <Link to="/services/wall-paintings" className="group px-2 py-4 border-b border-[#7FC5C5] flex justify-between items-center hover:bg-[#BDE1E1] transition-all duration-300">
    ...
    <path d="M27.6353 10.9791C28.3429 10.9791 28.9166 11.5527 28.9166 12.2603V27.6354C28.9166 28.343 28.3429 28.9166 27.6353 28.9166H12.2603C11.5526 28.9166 10.979 28.343 10.979 27.6354C10.979 26.9276 11.5526 26.3541 12.2603 26.3541H26.3541V12.2603C26.3541 11.5527 26.9276 10.9791 27.6353 10.9791Z" fill="#211D1E"/>
            ...
            <Link to="/services/wallpaper-supply" className="group px-2 py-4 border-b border-[#7FC5C5] flex justify-between items-center hover:bg-[#BDE1E1] transition-all duration-300">
    ...
    <path d="M27.6353 10.9791C28.3429 10.9791 28.9166 11.5527 28.9166 12.2603V27.6354C28.9166 28.343 28.3429 28.9166 27.6353 28.9166H12.2603C11.5526 28.9166 10.979 28.343 10.979 27.6354C10.979 26.9276 11.5526 26.3541 12.2603 26.3541H26.3541V12.2603C26.3541 11.5527 26.9276 10.9791 27.6353 10.9791Z" fill="#211D1E"/>
            ...
            {/* Curtains & Blinds */}
            <Link to="/services/curtains-blinds" className="group px-2 py-4 border-b border-[#7FC5C5] flex justify-between items-center hover:bg-[#BDE1E1] transition-all duration-300">
