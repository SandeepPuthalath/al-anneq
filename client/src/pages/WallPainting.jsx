  ...
  return (
    <div className="py-16 px-8">
      <div className="max-w-7xl mx-auto">
        {/* Page Title */}
        <h1 className="text-4xl font-bold text-[#18181B] mb-6 uppercase">Wall Painting</h1>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="py-3 border-b border-[#7FC5C5]">
                <span className="text-[#211D1E] font-medium">Normal wallpainting</span>
              </div>
              <div className="py-3 border-b border-[#7FC5C5]">
                <span className="text-[#211D1E] font-medium">Decorative painting</span>
              </div>
              <div className="py-3 border-b border-[#7FC5C5]">
                <span className="text-[#211D1E] font-medium">Epoxy painting</span>
              </div>
            </div>
          </div>
