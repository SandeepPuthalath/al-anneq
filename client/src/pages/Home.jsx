          ...
          <div className="relative bg-gray-800 h-96 md:h-auto flex items-center justify-center overflow-hidden">
            ...
            <img 
              ...
              className={`w-full h-full object-cover transition-opacity duration-500 ${
                imagesLoaded.services ? 'opacity-100' : 'opacity-0'
              }`}
      ...
      <div className="pb-16 px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="relative flex items-center justify-center overflow-hidden">
              ...
              <img 
                ...
                className={`w-full h-full object-cover transition-opacity duration-500 ${
                  imagesLoaded.customer ? 'opacity-100' : 'opacity-0'
                }`}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="relative flex items-center justify-center order-2 md:order-1 overflow-hidden">
              {!imagesLoaded.team && (
                <div className="absolute inset-0 bg-gray-200 animate-pulse">
                  <div className="w-full h-full linear-to-r from-gray-200 via-gray-300 to-gray-200"></div>
                </div>
              ...
              <img 
                ...
                className={`w-full h-full object-cover transition-opacity duration-500 ${
                  imagesLoaded.team ? 'opacity-100' : 'opacity-0'
                }`}
      ...
      <div className="px-8">
        <div className="grid grid-cols-2">
          {[
            ...
            <div key={image.key} className="relative bg-gray-300 overflow-hidden">
              ...
              <img 
                ...
                className={`w-full h-full object-cover hover:scale-105 transition-all duration-500 ${
                  imagesLoaded[image.key] ? 'opacity-100' : 'opacity-0'
                }`}
